        ...
        $.each(holders, function(hold_sel, btn_opts) {
          ...
          shower.mousedown(function(evt) {
            ...
            if ($('#tools_shapelib').is(":visible")) {
            	...
            	console.log("Location of interest");
            }
      ...
      */
      ...
      var deleteSelected = function() {
        if (selectedElement != null || multiselected) {
					beacon_array = jQuery.grep(beacon_array, function(value){
						console.log("Deleting UUID from array");
						var removedXTemp = selectedElement.id.split('');
						console.log("Selected element: " + selectedElement.id);
						var removedX = removedXTemp.splice(1);
						removedX = removedX.join('');
						console.log(removedX);
						return value != removedX;
					});
			...
			error: function(status){
                ...
                if(beacon_array.length == 0){
                  ...
                  _attachments: {
                    ...
                    $("#notifications").text("SVG saved in CouchDB");
